...
const Footer = () => {
  return (
    <footer className="border-t border-gray-800 bg-[#0F172A] py-12 text-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-2xl font-bold uppercase tracking-widest">Smart<span className='text-[#6366F1]'>Hire</span></h2>
            <p className="text-gray-400 text-sm mt-1">© 2024 SmartHire Recruitment. Premium AI-Hiring Solutions.</p>
          </div>
