      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-2xl font-bold uppercase tracking-widest text-slate-900">Smart<span className='text-indigo-600'>Hire</span></h2>
            <p className="text-slate-500 text-sm mt-1">© 2024 SmartHire Recruitment. Premium AI-Hiring Solutions.</p>
          </div>

          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="text-slate-400 hover:text-indigo-600" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="text-slate-400 hover:text-indigo-600" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="text-slate-400 hover:text-indigo-600" aria-label="LinkedIn">
